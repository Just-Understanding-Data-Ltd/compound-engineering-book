...
_Related chapters:_ - link:ch10-the-ralph-loop.md[Chapter 10: The RALPH Loop] for loop fundamentals - link:ch11-sub-agent-architecture.md[Chapter 11: Sub-Agent Architecture] for agent orchestration - link:ch13-building-the-harness.md[Chapter 13: Building the Harness] for infrastructure layers
