...
* *link:ch04-writing-your-first-claude-md.md[Chapter 4: Writing Your First CLAUDE.md]* for CLAUDE.md fundamentals
* *link:ch07-quality-gates-that-compound.md[Chapter 7: Quality Gates That Compound]* for quality gates in depth
* *link:ch09-context-engineering-deep-dive.md[Chapter 9: Context Engineering Deep Dive]* for context engineering principles
* *link:ch10-the-ralph-loop.md[Chapter 10: The RALPH Loop]* for the RALPH loop in long-running work
* *link:ch11-sub-agent-architecture.md[Chapter 11: Sub-Agent Architecture]* for sub-agent architecture patterns
