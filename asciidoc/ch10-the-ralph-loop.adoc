...
* *link:ch04-writing-your-first-claude-md.md[Chapter 4: Writing Your First CLAUDE.md]* for the documentation layer in depth
* *link:ch07-quality-gates-that-compound.md[Chapter 7: Quality Gates That Compound]* for the verification mechanisms
* *link:ch08-error-handling-and-debugging.md[Chapter 8: Error Handling & Debugging]* for the clean slate recovery pattern
* *link:ch09-context-engineering-deep-dive.md[Chapter 9: Context Engineering Deep Dive]* for context degradation theory
* *link:ch11-sub-agent-architecture.md[Chapter 11: Sub-Agent Architecture]* for multi-agent coordination
* *link:ch13-building-the-harness.md[Chapter 13: Building the Harness]* for the complete orchestration system
