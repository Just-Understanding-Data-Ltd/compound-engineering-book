...
[[fig-model-escalation]]
.Model Escalation: Cost-optimized selection flow from Haiku to Opus
image::ch15-model-escalation.png[Model Escalation,width=500,align=center]
...
[[fig-cost-protection-layers]]
.Four-Layer Cost Protection: Defense in depth against runaway API costs
image::ch15-cost-protection-layers.png[Cost Protection Layers,width=500,align=center]
...
// PDF: Full pricing table with all columns
ifdef::backend-pdf[]
...
// EPUB: Rotated format for narrow screens
ifndef::backend-pdf[]
*Haiku Pricing:*
...
NOTE: *Companion Code*: All 8 code examples for this chapter are available at https://github.com/Just-Understanding-Data-Ltd/compound-engineering-book/tree/main/examples/ch15[examples/ch15/]

_Related chapters:_

* *<<_chapter_7_quality_gates_that_compound,Chapter 7: Quality Gates That Compound>>* for automated gates that validate cheaper models
* *<<_chapter_10_the_ralph_loop,Chapter 10: The RALPH Loop>>* for cost management in long-running agents
* *<<_chapter_13_building_the_harness,Chapter 13: Building the Harness>>* for production cost optimization and telemetry
