...
* *link:ch10-the-ralph-loop.md[Chapter 10: The RALPH Loop]* for long-running agent automation built on workflows
* *link:ch11-sub-agent-architecture.md[Chapter 11: Sub-Agent Architecture]* for skills evolving into specialized sub-agents
* *link:ch13-building-the-harness.md[Chapter 13: Building the Harness]* for codifying workflows into production infrastructure
* *link:ch04-writing-your-first-claude-md.md[Chapter 4: Writing Your First CLAUDE.md]* for project instructions that workflows reference
