...
NOTE: *Companion Code*: All 4 code examples for this chapter are available at https://github.com/Just-Understanding-Data-Ltd/compound-engineering-book/tree/main/examples/ch04[examples/ch04/]

_Related chapters:_ - <<_chapter_2_getting_started_with_claude_code,Chapter 2: Getting Started with Claude Code>> for installation and basic tool usage - <<_chapter_3_prompting_fundamentals,Chapter 3: Prompting Fundamentals>> for techniques that make your CLAUDE.md instructions more effective - <<_chapter_9_context_engineering_deep_dive,Chapter 9: Context Engineering Deep Dive>> for advanced information theory behind context optimization
