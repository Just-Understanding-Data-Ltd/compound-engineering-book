...
____
*Companion Code*: All 5 code examples for this chapter are available at https://github.com/Just-Understanding-Data-Ltd/compound-engineering-book/tree/main/examples/ch05[examples/ch05/]
____

_Related chapters:_ - *link:ch04-writing-your-first-claude-md.md[Chapter 4: Writing Your First CLAUDE.md]* for context engineering fundamentals that support Factor 3 - *link:ch06-the-verification-ladder.md[Chapter 6: The Verification Ladder]* for building on the verification concepts in Factors 6-9 - *link:ch10-the-ralph-loop.md[Chapter 10: The RALPH Loop]* for long-running agent patterns that apply the 12 factors - *link:ch11-sub-agent-architecture.md[Chapter 11: Sub-Agent Architecture]* for expanding on Factor 10’s focused agent approach
