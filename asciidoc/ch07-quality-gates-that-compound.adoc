...
* *link:ch06-the-verification-ladder.md[Chapter 6: The Verification Ladder]* for the hierarchy of verification methods that gates automate
* *link:ch08-error-handling-and-debugging.md[Chapter 8: Error Handling & Debugging]* for handling gate failures gracefully
* *link:ch04-writing-your-first-claude-md.md[Chapter 4: Writing Your First CLAUDE.md]* for the CLAUDE.md gate that ties everything together
