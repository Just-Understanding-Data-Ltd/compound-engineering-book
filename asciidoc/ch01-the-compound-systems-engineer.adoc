...
The next chapter covers getting started with Claude Code, the tool that makes Level 3 engineering practical for solo developers. See link:ch02-getting-started-with-claude-code.md[Chapter 2: Getting Started with Claude Code].

'''''

____
*Companion Code*: All 2 code examples for this chapter are available at https://github.com/Just-Understanding-Data-Ltd/compound-engineering-book/tree/main/examples/ch01[examples/ch01/]
____

_Related chapters:_ - link:ch09-context-engineering-deep-dive.md[Chapter 9: Context Engineering Deep Dive] for deep dives on constraints and observability - link:ch10-the-ralph-loop.md[Chapter 10: The RALPH Loop] for the practical execution system - link:ch13-building-the-harness.md[Chapter 13: Building the Harness] for implementing the four-layer infrastructure
