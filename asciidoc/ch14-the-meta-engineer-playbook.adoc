...
* *link:ch01-the-compound-systems-engineer.md[Chapter 1: The Compound Systems Engineer]* introduced the identity. This chapter operationalizes it.
* *link:ch07-quality-gates-that-compound.md[Chapter 7: Quality Gates That Compound]* covered quality gates. Meta-engineers automate gate enforcement.
* *link:ch10-the-ralph-loop.md[Chapter 10: The RALPH Loop]* covered the RALPH loop. Meta-engineers build infrastructure that makes it run autonomously.
* *link:ch11-sub-agent-architecture.md[Chapter 11: Sub-Agent Architecture]* covered sub-agents. Meta-engineers design the orchestration layer.
* *link:ch13-building-the-harness.md[Chapter 13: Building the Harness]* covered harness construction. This chapter explains why the harness matters.
