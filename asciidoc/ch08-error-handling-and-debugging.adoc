...
____
*Companion Code*: All 7 code examples for this chapter are available at https://github.com/Just-Understanding-Data-Ltd/compound-engineering-book/tree/main/examples/ch08[examples/ch08/]
____

_Related chapters:_

* *link:ch06-the-verification-ladder.md[Chapter 6: The Verification Ladder]* for the verification patterns that catch errors early
* *link:ch07-quality-gates-that-compound.md[Chapter 7: Quality Gates That Compound]* for quality gates that automate prevention
* *link:ch09-context-engineering-deep-dive.md[Chapter 9: Context Engineering Deep Dive]* for context engineering principles that improve AI output
* *link:ch10-the-ralph-loop.md[Chapter 10: The RALPH Loop]* for error recovery in long-running agent workflows
* *link:ch15-model-strategy-and-cost-optimization.md[Chapter 15: Model Strategy & Cost Optimization]* for cost optimization and budget protection strategies
