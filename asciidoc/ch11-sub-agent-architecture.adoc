...
____
*Companion Code*: All 5 code examples for this chapter are available at https://github.com/Just-Understanding-Data-Ltd/compound-engineering-book/tree/main/examples/ch11[examples/ch11/]
____

_Related chapters:_

* *link:ch04-writing-your-first-claude-md.md[Chapter 4: Writing Your First CLAUDE.md]* for the foundation of three-layer context hierarchy
* *link:ch06-the-verification-ladder.md[Chapter 6: The Verification Ladder]* for the verification patterns sub-agents enforce
* *link:ch07-quality-gates-that-compound.md[Chapter 7: Quality Gates That Compound]* for how sub-agent output flows through quality gates
* *link:ch10-the-ralph-loop.md[Chapter 10: The RALPH Loop]* for how sub-agents integrate into the autonomous development cycle
* *link:ch15-model-strategy-and-cost-optimization.md[Chapter 15: Model Strategy & Cost Optimization]* for using different model tiers for different agent roles
