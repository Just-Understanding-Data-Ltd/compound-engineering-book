...
____
*Companion Code*: All 3 code examples for this chapter are available at https://github.com/Just-Understanding-Data-Ltd/compound-engineering-book/tree/main/examples/ch06[examples/ch06/]
____

_Related chapters:_

* *link:ch05-the-12-factor-agent.md[Chapter 5: The 12-Factor Agent]* for the reliability principles that verification enforces
* *link:ch07-quality-gates-that-compound.md[Chapter 7: Quality Gates That Compound]* for building verification systems that improve over time
* *link:ch03-prompting-fundamentals.md[Chapter 3: Prompting Fundamentals]* for structuring prompts that produce testable code
