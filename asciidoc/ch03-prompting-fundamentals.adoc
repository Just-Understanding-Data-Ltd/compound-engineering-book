...
The next chapter applies these prompting fundamentals to CLAUDE.md files. You will learn to structure project context that makes every prompt more effective without additional effort. See link:ch04-writing-your-first-claude-md.md[Chapter 4: Writing Your First CLAUDE.md].

'''''

____
*Companion Code*: All 3 code examples for this chapter are available at https://github.com/Just-Understanding-Data-Ltd/compound-engineering-book/tree/main/examples/ch03[examples/ch03/]
____

_Related chapters:_ - link:ch02-getting-started-with-claude-code.md[Chapter 2: Getting Started with Claude Code] for tool usage and basic patterns - link:ch04-writing-your-first-claude-md.md[Chapter 4: Writing Your First CLAUDE.md] for project context configuration - link:ch09-context-engineering-deep-dive.md[Chapter 9: Context Engineering Deep Dive] for advanced information theory applications
