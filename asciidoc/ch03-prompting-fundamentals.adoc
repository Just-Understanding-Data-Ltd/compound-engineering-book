...
[[fig-constraint-funnel]]
.The Constraint Funnel: Each layer reduces possibilities by an order of magnitude
image::ch03-constraint-funnel.png[Constraint Funnel,width=600,align=center]
