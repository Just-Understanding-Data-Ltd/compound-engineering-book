# Chapter 12: Development Workflows {#_chapter_12:_development_workflows} {#ch12-development-workflows}

[]{.index term="workflows"} []{.index term="plan mode"} []{.index term="git worktrees"}
...
## Plan Mode: Think Before You Implement {#_plan_mode:_think_before_you_implement}
...
### The Two-Phase Pattern {#_the_two_phase_pattern}
...
### When to Use Plan Mode {#_when_to_use_plan_mode}
...
### Effective Plan Mode Prompts {#_effective_plan_mode_prompts}
...
### Iterating on Plans {#_iterating_on_plans}
...
## Git Worktrees for Parallel Development {#_git_worktrees_for_parallel_development}
...
### How Worktrees Work {#_how_worktrees_work}
...
### Creating and Using Worktrees {#_creating_and_using_worktrees}
...
### Symlinked Configurations {#_symlinked_configurations}
...
### Parallel Development Metrics {#_parallel_development_metrics}
...
## Incremental Development Pattern {#_incremental_development_pattern}
...
### The Problem with Large Requests {#_the_problem_with_large_requests}
...
### The Incremental Pattern {#_the_incremental_pattern}
...
### Authentication System: Incremental Approach {#_authentication_system:_incremental_approach}
...
``` typescript
// Request: "Create User interface with id,
// email, passwordHash fields"
...
``` typescript
// Request: "Add hashPassword and verifyPassword
// functions using bcrypt"
...
### Why Incrementality Works {#_why_incrementality_works}
...
## Ad-Hoc to Deterministic Scripts {#_ad_hoc_to_deterministic_scripts}

If you run the same agent flow repeatedly, convert it to a script. Deterministic beats probabilistic for known workflows.

### The Conversion Signal {#_the_conversion_signal}

Watch for patterns in your prompts: - "Run the tests, fix any failures, then lint" - "Deploy to staging, run smoke tests, notify Slack" - "Pull latest, rebase, run tests, push"
...
### The Latency Argument {#_the_latency_argument}

    Ad-hoc flow: 45 seconds (LLM reasoning + execution)
    Script: 3 seconds (just execution)

Over 10 runs: - Ad-hoc: 7.5 minutes - Script: 30 seconds
...
## Playwright Script Loop {#_playwright_script_loop}
...
### Speed Comparison {#_speed_comparison}
...
### Why Scripts Are Superior {#_why_scripts_are_superior}
...
### The Iteration Loop {#_the_iteration_loop}
...
## AST-Grep for Precision Transformations {#_ast_grep_for_precision_transformations}
...
### The Problem with Text Search {#_the_problem_with_text_search}

``` bash
$ grep -r "fetchUserData" .

./src/api/users.ts:  const userData = await fetchUserData(userId);
./src/api/users.ts:  // TODO: fetchUserData should
                     // handle errors better
./src/api/users.ts:  console.log("Calling fetchUserData");
./README.md:The `fetchUserData` function retrieves
...
### Refactoring with AST-Grep {#_refactoring_with_ast_grep}
...
### When to Use Each Tool {#_when_to_use_each_tool}
...
## Skills System Deep Dive {#_skills_system_deep_dive}
...
### Exercise 1: Plan Mode Practice {#_exercise_1:_plan_mode_practice}
...
### Exercise 2: Parallel Development Setup {#_exercise_2:_parallel_development_setup}
...
### Exercise 3: Script Capture {#_exercise_3:_script_capture}
...
- **[Chapter 10: The RALPH Loop](#_chapter_10_the_ralph_loop){.cross-reference}** for long-running agent automation built on workflows

- **[Chapter 11: Sub-Agent Architecture](#_chapter_11_sub_agent_architecture){.cross-reference}** for skills evolving into specialized sub-agents

- **[Chapter 13: Building the Harness](#_chapter_13_building_the_harness){.cross-reference}** for codifying workflows into production infrastructure

- **[Chapter 4: Writing Your First CLAUDE.md](#_chapter_4_writing_your_first_claude_md){.cross-reference}** for project instructions that workflows reference
