# Chapter 7: Quality Gates That Compound {#_chapter_7:_quality_gates_that_compound} {#ch07-quality-gates-that-compound}

[]{.index term="quality gates"} []{.index term="CI/CD"}
...
## Gates as Information Filters {#_gates_as_information_filters}
...
### The Mathematics {#_the_mathematics}
...
::: {#fig-state-space-reduction wrapper="1" align="center" width="600"}
![State Space Reduction: Each gate intersection shrinks the set of valid programs](ch07-state-space-reduction.png){alt="State Space Reduction"}
:::
...
::: {#fig-quality-gates-filters wrapper="1" align="center" width="700"}
![Quality Gates as Information Filters: Progressive state space reduction](ch07-quality-gates-filters.png){alt="Quality Gates as Filters"}
:::

### A Concrete Example {#_a_concrete_example}
...
describe('authenticate', () => {
  ...
  it('returns success=false for invalid email',
     async () => {
...
## Why Gates Multiply, Not Add {#_why_gates_multiply,_not_add}
...
### The Compounding Formula {#_the_compounding_formula}
...
::: {#fig-compounding-effect wrapper="1" align="center" width="700"}
![The Compounding Effect: Quality gates multiply, not add](ch07-compounding-effect.png){alt="Compounding Effect"}
:::

### Why Multiplication is Correct {#_why_multiplication_is_correct}
...
### Three Reasons Compounding Happens {#_three_reasons_compounding_happens}
...
## Automating Gates with Claude Code Hooks {#_automating_gates_with_claude_code_hooks}
...
### Linting Hook Example {#_linting_hook_example}
...
### Type Checking Hook {#_type_checking_hook}
...
### Chaining Multiple Gates {#_chaining_multiple_gates}
...
### The Keyboard Shortcut {#_the_keyboard_shortcut}
...
### Real-World Impact {#_real_world_impact}

::: {#fig-manual-vs-auto-verification wrapper="1" align="center" width="600"}
![Manual vs Automated Verification: Hooks deliver 60-70% time savings](ch07-manual-vs-auto-verification.png){alt="Manual vs Auto Verification"}
:::

Without hooks: - 8-10 minutes per feature - 6 manual commands - Multiple back-and-forth cycles

With hooks: - 2-3 minutes per feature - 0 manual commands - Automatic feedback loops

Result: 60-70% time savings with zero manual intervention.

## Early Linting Prevents Technical Debt {#_early_linting_prevents_technical_debt}
...
### The Mathematics of Technical Debt {#_the_mathematics_of_technical_debt}
...
### Day Zero Setup {#_day_zero_setup}
...
## How Gates Teach AI Agents {#_how_gates_teach_ai_agents}
...
### Knowledge Accumulation {#_knowledge_accumulation}
...
### Reduced Context Switching {#_reduced_context_switching}
...
## Trust But Verify: AI-Generated Tests Over Manual Review {#_trust_but_verify:_ai_generated_tests_over_manual_review}
...
### The Manual Review Problem {#_the_manual_review_problem}
...
### The Trust But Verify Pattern {#_the_trust_but_verify_pattern}
...
### Four Verification Patterns {#_four_verification_patterns}
...
### The Compound Learning Effect {#_the_compound_learning_effect}
...
### Metrics That Matter {#_metrics_that_matter}
...
## Building the Gate Stack {#_building_the_gate_stack}

### The Six-Gate Architecture {#_the_six_gate_architecture}
...
### Implementation Order {#_implementation_order}

Week 1: Types + Hooks (type checking on every edit) Week 2: Tests + Hooks (tests run on every file write) Week 3: Linting + CLAUDE.md (consistent patterns, documented for LLMs) Week 4: CI/CD automation (GitHub Actions for lint, test, review) Week 5+: Refine rules, add DDD patterns, evolve CLAUDE.md

Reality: order matters less than completeness. Get all 6 gates as quickly as possible to capture compounding.

### Measuring Gate Health {#_measuring_gate_health}
...
## Stateless Verification: Preventing Ghost Failures {#_stateless_verification:_preventing_ghost_failures}
...
### The State Accumulation Problem {#_the_state_accumulation_problem}
...
### The Clean Slate Principle {#_the_clean_slate_principle}
...
### What State to Reset {#_what_state_to_reset}
...
### Measuring Statelessness {#_measuring_statelessness}
...
### Exercise 1: Set Up Claude Code Hooks {#_exercise_1:_set_up_claude_code_hooks}
...
### Exercise 2: Calculate Your Compounding Bonus {#_exercise_2:_calculate_your_compounding_bonus}
...
### Exercise 3: Early Linting ROI {#_exercise_3:_early_linting_roi}
...
- **[Chapter 6: The Verification Ladder](#_chapter_6_the_verification_ladder){.cross-reference}** for the hierarchy of verification methods that gates automate

- **[Chapter 8: Error Handling & Debugging](#_chapter_8_error_handling_and_debugging){.cross-reference}** for handling gate failures gracefully

- **[Chapter 4: Writing Your First CLAUDE.md](#_chapter_4_writing_your_first_claude_md){.cross-reference}** for the CLAUDE.md gate that ties everything together
