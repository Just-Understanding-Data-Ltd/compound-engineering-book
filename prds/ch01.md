...
- `@~/Desktop/knowledge-base/01-Compound-Engineering/context-engineering/liquidation-cadence.md` - When to ship vs. when to persist; liquidation timing strategy
- `@~/Desktop/knowledge-base/01-Compound-Engineering/context-engineering/building-the-harness.md` - Harness philosophy and why infrastructure precedes products
- `@~/Desktop/knowledge-base/01-Compound-Engineering/context-engineering/building-the-factory.md` - Factory vs. product mindset; meta-infrastructure patterns
- `@~/Desktop/knowledge-base/01-Compound-Engineering/context-engineering/compound-flywheel-effect.md` - How leverage compounds across projects
...
**Updated January 28, 2026 to reflect 15-chapter structure**

The chapter includes forward references to the following related chapters:

- **Chapter 2: "Getting Started with Claude Code"** - Practical tools and setup for implementing Level 3 engineering
- **Chapter 9: "Context Engineering Deep Dive"** - Technical foundations for constraints and context window optimization
- **Chapter 10: "The RALPH Loop"** - The practical execution system for long-running agent work and iterative improvement
- **Chapter 13: "Building the Harness"** - Deep dive into the infrastructure layer (observability, constraints, environments) that enables compound leverage
- **Chapter 14: "The Meta-Engineer Playbook"** - Detailed patterns and decision frameworks for operating at Level 3

See chapter text (lines 354-361) for the exact context in which these references appear.
...
| Jan 28, 2026 | Claude | Draft | Updated Section 8 cross-references to match 15-chapter structure |
