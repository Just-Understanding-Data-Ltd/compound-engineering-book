...
- `@kb/01-Compound-Engineering/my-doctrine.md` - The foundational philosophy, risk framework, and decision logic
- `@kb/01-Compound-Engineering/context-engineering/the-meta-engineer-identity.md` - The identity shift and skill stack required
- `@kb/01-Compound-Engineering/software-archetypes.md` - Archetype comparison and failure modes
- `@kb/01-Compound-Engineering/index.md` - Quick reference and key metrics
