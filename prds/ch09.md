# Chapter 9 PRD: Sub-Agent Architecture
...
- `sub-agent-context-hierarchy.md` (TO BE CREATED) – Deep dive into context isolation patterns between sub-agents
- `tool-access-control.md` (TO BE CREATED) – Permission boundaries and capability restriction patterns
- `orchestration-patterns.md` (TO BE CREATED) – Coordinator, swarm, pipeline, and actor-critic orchestration implementations
- `actor-critic-pattern.md` (TO BE CREATED) – Detailed writer agent + reviewer agent implementation patterns
- `agent-memory-patterns.md` (TO BE CREATED) – Checkpoint/resume and state persistence for long-running agents
...
- LLMs are probabilistic—4 runs find more issues than 1 run
