...
- [integration-testing-patterns.md](integration-testing-patterns.md) - Integration tests as quality gates; higher signal-to-noise for LLM code (10-20x)
- [stateless-verification-loops.md](stateless-verification-loops.md) - Stateless verification prevents state accumulation between gate runs
- [trust-but-verify-protocol.md](trust-but-verify-protocol.md) - AI-generated verification scripts reduce review burden by 99%
